...
const I18N_DICT = {
  ...
  sec10_ing_mens:        { es: 'Ingresos mensuales (COP)',          en: 'Monthly income (COP)' },
  sec10_pas_total:       { es: 'Pasivos totales (COP)',             en: 'Total liabilities (COP)' },
  sec10_egr_mens:        { es: 'Egresos mensuales (COP)',           en: 'Monthly expenses (COP)' },
  ...
  sec11_cert_tip:        { es: 'Esta es la cuenta donde se realizará el pago. Debe coincidir con la certificación bancaria adjuntada en los documentos.',
                           en: 'This is the account where payment will be made. It must match the bank certification attached in the documents.' },

  /* ── Sección 12 ── PEP ──────────────────────────────────────────────── */
  sec12_title:           { es: 'PEP — Exposición política',         en: 'PEP — Political Exposure' },
  sec12_tip:             { es: 'PEP (Persona Expuesta Políticamente): persona que ejerce o ha ejercido cargos o funciones públicas prominentes en el país o en el exterior, como jefes de Estado, políticos, funcionarios judiciales, militares de alto rango, directivos de empresas públicas, o que tiene vínculos cercanos con dichas personas (familiares directos, asociados).',
                           en: 'PEP (Politically Exposed Person): a person who holds or has held prominent public positions in Colombia or abroad, such as heads of state, politicians, senior judicial or military officers, executives of state-owned enterprises, or who has close ties to such persons (immediate family, known associates).' },
  ...
  sec13_cert_info:       { es: 'Certifico que la información sobre activos virtuales es correcta y completa.', en: 'I certify that the information on virtual assets is correct and complete.' },
  ...
  sec14_cert_exis:       { es: 'Certificado de existencia y representación legal', en: 'Certificate of existence and legal representation' },
  ...
  sec14_est_fin_1:       { es: 'Estados financieros año 1',         en: 'Financial statements year 1' },
  ...
  sec14_decl_renta:      { es: 'Declaración de renta o juramentada', en: 'Tax return or sworn declaration' },
  ...
  /* ── Sección 3 — dirección ───────────────────────────────────────────── */
  sec3_dir_oficina:        { es: 'Dirección oficina principal (Registrada la sociedad)', en: 'Main office address (Company registered address)' },
  ...
  sec10_note:              { es: 'Los valores de ingresos, egresos y demás campos financieros corresponden a cifras mensuales en pesos colombianos (COP), salvo los totales de activos, pasivos y patrimonio que son valores de balance.', en: 'Income, expenses and other financial fields correspond to monthly figures in Colombian pesos (COP), except for total assets, liabilities and equity which are balance sheet values.' },
